...
BuildRequires:	kf5-kcmutils-devel >= 5.22
BuildRequires:	kf5-kconfig-devel >= 5.22
BuildRequires:	kf5-kcoreaddons-devel >= 5.22
BuildRequires:	kf5-kcrash-devel >= 5.22
BuildRequires:	kf5-kdoctools-devel >= 5.22
BuildRequires:	kf5-ki18n-devel >= 5.22
BuildRequires:	kf5-kio-devel >= 5.22
BuildRequires:	kf5-knewstuff-devel >= 5.22
